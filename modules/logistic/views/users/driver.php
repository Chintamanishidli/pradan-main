...
<div id="wrapper">
    <div class="content">
        ...
        <div class="row">
            ...
            <div class="col-md-12">
                ...
                <div class="tw-flex tw-justify-between">
                    <h4 class="tw-mb-0 tw-font-semibold tw-text-lg tw-text-neutral-700">
                        <?php echo lg_html_entity_decode($member->firstname . ' ' . $member->lastname); ?>
            ...
            <?php echo form_hidden('staff_type', 'driver'); ?>
                        ...
                        <div class="tab-content tw-mt-5">
                            <div role="tabpanel" class="tab-pane active" id="tab_staff_profile">
                                ...
                                <div class="form-group col-md-4">
                                  ...
                                  echo lg_html_entity_decode($member->skype);
                              } ?>">
                                </div>
                              ...
                              ?>
                                        <input type="checkbox" id="dep_<?php echo lg_html_entity_decode($department['departmentid']); ?>"
                                            name="departments[]" value="<?php echo lg_html_entity_decode($department['departmentid']); ?>"
                                            <?php echo lg_html_entity_decode($checked); ?>>
                                        <label
                                            for="dep_<?php echo lg_html_entity_decode($department['departmentid']); ?>"><?php echo lg_html_entity_decode($department['name']); ?></label>
                                    </div>
                                    <?php } ?>
                                </div>
                        ...
                        <div class="mtop15">
                            <table class="table dt-table" data-order-col="2" data-order-type="desc">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        <td width="50%">
                                            <div data-note-description="<?php echo lg_html_entity_decode($note['id']); ?>">
                                                <?php echo check_for_links($note['description']); ?>
                                            </div>
                                            <div data-note-edit-textarea="<?php echo lg_html_entity_decode($note['id']); ?>"
                                                class="hide inline-block full-width">
                                                <textarea name="description" class="form-control"
                                                    rows="4"><?php echo clear_textarea_breaks($note['description']); ?></textarea>
                                                <div class="text-right mtop15">
                                                    <button type="button" class="btn btn-default"
                                                        onclick="toggle_edit_note(<?php echo lg_html_entity_decode($note['id']); ?>);return false;"><?php echo _l('cancel'); ?></button>
                                                    <button type="button" class="btn btn-primary"
                                                        onclick="edit_note(<?php echo lg_html_entity_decode($note['id']); ?>);"><?php echo _l('update_note'); ?></button>
                                                </div>
                                            </div>
                                        </td>
                                        <td><?php echo lg_html_entity_decode($note['firstname'] . ' ' . $note['lastname']); ?></td>
                                        <td data-order="<?php echo lg_html_entity_decode($note['dateadded']); ?>">
                                            <?php echo _dt($note['dateadded']); ?></td>
                                        <td>
                                            <div class="tw-flex tw-items-center tw-space-x-3">
                                                <?php if ($note['addedfrom'] == get_staff_user_id() || has_permission('staff', '', 'delete')) { ?>
                                                <a href="#"
                                                    onclick="toggle_edit_note(<?php echo lg_html_entity_decode($note['id']); ?>);return false;"
                    ...
                    <div class="panel-body">
                        ...
                        <table class="table dt-table">
                           ...
                           foreach ($timesheets as $t) { ?>
                                <tr>
                                    <td><a href="#"
                                            onclick="init_task_modal(<?php echo lg_html_entity_decode($t['task_id']); ?>); return false;"><?php echo lg_html_entity_decode($t['name']); ?></a>
                                    </td>
                                    <td data-order="<?php echo lg_html_entity_decode($t['start_time']); ?>">
                                        <?php echo _dt($t['start_time'], true); ?></td>
                                    <td data-order="<?php echo lg_html_entity_decode($t['end_time']); ?>">
                                        <?php
                                 ...
                                 if ($t['not_finished'] && (is_admin() || $t['staff_id'] === get_staff_user_id())) {
                                     ?>
                                        <a href="#" <?php
                                          ...
                                          onclick="timer_action(this, <?php echo lg_html_entity_decode($t['task_id']); ?>, <?php echo lg_html_entity_decode($t['id']); ?>, 1);" class="btn btn-primary btn-sm"><?php echo _l('save'); ?></button>'
                                            onclick="return false;" <?php } else { ?>
                                            onclick="timer_action(this, <?php echo lg_html_entity_decode($t['task_id']); ?>, <?php echo lg_html_entity_decode($t['id']); ?>, 1); return false;"
